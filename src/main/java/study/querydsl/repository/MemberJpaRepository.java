...
public class MemberJpaRepository {
    ...
    public List<MemberTeamDto> searchByBuilder(MemberSearchConditionDto condition) {
    ...
    public List<MemberTeamDto> searchByWhere(MemberSearchConditionDto condition) {
        return queryFactory
                .select(new QMemberTeamDto(
                        member.id,
                        member.username,
